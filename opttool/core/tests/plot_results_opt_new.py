...
def plot_results(prosumers, outputs):
	...
	ax6.bar(offset_series, b_pdis_load, width=1 / 2, align='edge', edgecolor='silver',
			alpha=1.0, bottom=p_gen_pv_load+p_gen_wind_load, color='b')
	ax6.bar(offset_series, pcc_pin_load, width=1 / 2, align='edge', edgecolor='silver',
			alpha=1.0, bottom=p_gen_pv_load+p_gen_wind_load+b_pdis_load, color='k')
	...
	ax7.bar(offset_series, p_gen_pv_load, width=1 / 2, align='edge', edgecolor='silver',
			alpha=1.0, color='r')
	ax7.bar(offset_series, p_gen_pv_bat, width=1 / 2, align='edge', edgecolor='silver',
			alpha=1.0, bottom=p_gen_pv_load, color='g')
	ax7.bar(offset_series, pcc_pout_pv, width=1 / 2, align='edge', edgecolor='silver',
			alpha=1.0, bottom=p_gen_pv_load+p_gen_pv_bat, color='b')
	...
	ax8.bar(offset_series, p_gen_wind_load, width=1 / 2, align='edge', edgecolor='silver',
			alpha=1.0, color='r')
	ax8.bar(offset_series, p_gen_wind_bat, width=1 / 2, align='edge', edgecolor='silver',
			alpha=1.0, bottom=p_gen_wind_load, color='g')
	ax8.bar(offset_series, pcc_pout_wind, width=1 / 2, align='edge', edgecolor='silver',
			alpha=1.0, bottom=p_gen_wind_load + p_gen_wind_bat, color='b')
	...
	ax9.bar(time_series, b_energy, width=1 / 2, align='edge', edgecolor='silver', color='lightgreen',
			alpha=1.0)
